<div class="max-w-5xl mx-auto py-10 px-4">
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
        <div class="bg-[#1e293b] p-4 flex justify-between items-center">
            <h2 class="text-white font-bold text-lg uppercase">Novo Cadastro de Produto</h2>
        ...
        <form wire:submit.prevent="salvar" class="p-8">
            @if($abaAtiva == 'geral')
                <div class="mb-8 p-4 bg-blue-50 rounded-xl border-l-4 border-blue-600">
                    <label class="block text-xs font-black text-blue-800 mb-2 uppercase tracking-widest flex items-center gap-2">
                    ...
                    <div class="relative">
                        <input type="text"
                               ...
                               class="w-full text-lg font-bold border-2 border-blue-200 rounded-lg p-3 pl-12 shadow-sm outline-none focus:border-blue-500 transition-all uppercase">
