<div class="max-w-4xl mx-auto py-8">
    <div class="bg-white shadow-xl rounded-lg overflow-hidden border border-gray-200">
        <div class="bg-gray-800 p-4 flex justify-between items-center">
            <h2 class="text-white font-bold text-xl">Editar Cadastro: {{ $nome }}</h2>
            <a href="{{ route('clientes.index') }}"
                class="text-gray-300 hover:text-white text-sm font-semibold flex items-center transition">
        ...
        <form wire:submit.prevent="salvar" class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-700">Limite de Crédito (R$)</label>
                    <input type="number" step="0.01" wire:model="limite_credito"
                        class="w-full border-gray-300 rounded-md shadow-sm p-2 border bg-blue-50 focus:ring-blue-500">
                    <p class="text-xs text-gray-500 mt-1">Valor disponível para vendas em duplicata.</p>
                </div>
            </div>
